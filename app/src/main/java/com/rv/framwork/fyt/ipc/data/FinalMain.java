...
package com.rv.framwork.fyt.ipc.data;
...
public class FinalMain {
	...
	public static final int C_360CAMERA_BACKCAR_ENABLE	= 56;	// 名途360全景倒车使能开关
...
//	public static final int MCU_STATE_LAST				= -2; 	// ?
	...
	public static final int LANG_KR						= 9;	//韩语
...
//	public static final int VIDEO_NP_NULL		= 0;
	 ...
	 * 语音助手命令
	 */
	public static final int VA_CMD_UNKNOW				= -1;	// UNKNOW
	public static final int VA_CMD_KEY_HOME				= 0;	// 主页键
	public static final int VA_CMD_KEY_PLAY				= 1;	// 播放
	public static final int VA_CMD_KEY_PAUSE			= 2;	// 暂停
	public static final int VA_CMD_KEY_STOP				= 3;	// 停止
	public static final int VA_CMD_KEY_FF				= 4;	// 快进
	public static final int VA_CMD_KEY_FB				= 5;	// 快退
	public static final int VA_CMD_KEY_DISC_IN			= 6;	// 进仓
	public static final int VA_CMD_KEY_DISC_OUT			= 7; 	// 出仓
	public static final int VA_CMD_KEY_DIAL				= 8; 	// 接听
	public static final int VA_CMD_KEY_HANG				= 9; 	// 挂断、挂了
	public static final int VA_CMD_KEY_SKIPB			= 10;	// 上一曲、上一首、换一首、换一曲、换上一曲
	public static final int VA_CMD_KEY_SKIPF			= 11;	// 下一曲、下一首、换下一曲
	public static final int VA_CMD_KEY_VOLPLUS			= 12;	// 音量加
	public static final int VA_CMD_KEY_VOLMINUS			= 13;	// 音量减
	public static final int VA_CMD_KEY_LINK_BT			= 14;	// 连接手机、开始连接
	public static final int VA_CMD_KEY_CUT_BT			= 15;	// 断开连接、断开手机、断开
	public static final int VA_CMD_KEY_NAVI				= 16;	// 导航键    1打开  0关闭    
	
	public static final int VA_CMD_RADIO_SCAN 			= 17;	// 扫描
	public static final int VA_CMD_RADIO_BAND 			= 18;	// 波段
	public static final int VA_CMD_RADIO_FREQPLUS 		= 19;	// 频率加
	public static final int VA_CMD_RADIO_FREQMINUS 		= 20;	// 频率减
	public static final int VA_CMD_RADIO_SEARCHF		= 21;	// 向前自动搜台，频率加
	public static final int VA_CMD_RADIO_SEARCHB		= 22;	// 向后自动搜台，频率减
	public static final int VA_CMD_RADIO_SEARCH			= 23;	// 自动搜台、搜台、搜下台
	public static final int VA_CMD_RADIO_STORE			= 24;	// 存台
	public static final int VA_CMD_RADIO_EDIT			= 25;	// 编辑
	public static final int VA_CMD_RADIO_RADIOSET		= 26;	// 收音机设置
	public static final int VA_CMD_RADIO_FREQ			= 27;	// 发具体的频点 new String{freq};
	public static final int VA_CMD_RADIO_SELECTONE		= 28;	// 第一、第一台、第一个台 new int{cmd, index}
	public static final int VA_CMD_MUSIC_PATH			= 29;	// 歌曲 new String{url}
	public static final int VA_CMD_PHONE_CONTACT		= 30;	// 电话联系人  new String{name} 
	public static final int VA_CMD_PHONE_NUMBER			= 31;	// 电话号码 new String{num}

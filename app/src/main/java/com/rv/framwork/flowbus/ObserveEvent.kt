package com.rv.framwork.flowbus
...
import com.rv.framwork.flowbus.ApplicationScopeViewModelProvider
import com.rv.framwork.flowbus.EventBusCore
...
/*
@MainThread
inline fun <reified T> BaseVmFragment<*>.observeEvent(
    dispatcher: CoroutineDispatcher = Dispatchers.Main.immediate,
    minActiveState: Lifecycle.State = Lifecycle.State.STARTED,
    isSticky: Boolean = false,
    noinline onReceived: (T) -> Unit
